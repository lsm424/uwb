...
class Cir2121:
    ...
    def init(out_file_dir):
        ...
        Cir2121.csv_file = open(f'{Cir2121.NAME}.csv', 'a', newline='', encoding='utf-8')
        Cir2121.writer = csv.writer(Cir2121.csv_file)
        Cir2121.t = threading.Thread(target=save, args=(Cir2121.writer, Cir2121.save_queue, Cir2121.csv_file), daemon=True)
        Cir2121.t.start()
